...
echo 'export FMS_DB_PORT_3306_TCP_ADDR="localhost"' >> $HOME/.bash_profile
echo 'export FMS_DB_PORT_3306_TCP_PORT="3306"' >> $HOME/.bash_profile
echo 'export FMS_DB_USERNAME="<UPDATE ME>"' >> $HOME/.bash_profile
echo 'export FMS_DB_PASSWORD="<UPDATE ME>"' >> $HOME/.bash_profile
echo 'export FMS_DB_NAME="<UPDATE ME>"' >> $HOME/.bash_profile
echo 'export FMS_SECRET_KEY="<UPDATE ME>"' >> $HOME/.bash_profile
echo 'export FMS_SMTP_USERNAME="<UPDATE ME>"' >> $HOME/.bash_profile
echo 'export FMS_SMTP_PASSWORD="<UPDATE ME>"' >> $HOME/.bash_profile
echo 'export FMS_SMTP_SERVER="smtp.gmail.com"' >> $HOME/.bash_profile
echo 'export FMS_SMTP_PORT=587' >> $HOME/.bash_profile