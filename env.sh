...
echo 'export FMS_DB_NAME="deco3801"' >> $HOME/.bash_profile         # Remember to replace this as necessary.
echo 'export FMS_SMTP_USERNAME="<username>"' >> $HOME/.bash_profile # Ask Andrew C for this.
echo 'export FMS_SMTP_PASSWORD="<password>"' >> $HOME/.bash_profile # Ask Andrew C for this.
